  ...
  */
  ...
  public static function get_shortcode_option_params( $params ) {
    ...
    $defaults = array(
      ...
      'extended_album_description_enable' => ($use_option_defaults ? $wd_bwg_options->extended_album_description_enable : (isset($params['extended_album_description_enable']) ? $params['extende